      ...
      <el-container>
        ...
        <el-container class="content">
          <el-main class="main">
              ...
              <el-table-column prop="program" label="项目奖金"> </el-table-column>
              <el-table-column prop="bonus" label="年终奖">
              </el-table-column>
              <el-table-column prop="investment" label="投资收入">
              </el-table-column>
            </el-table>
            <div class="piechart">
    ...
    getListPage() {
      ajax({
        ...
        .then((res) => {
          ...
          //找到所有的salay的数据进行求和
          let arr1 =this.findall(arr,'salary')
          let arr2 = []
          for(let i in arr1){
          ...
          //找到所有的年终奖的数据进行求和
          let bonus =this.findall(arr,'年终奖')
          let bonus1 = []
          for(let i in bonus){
          ...
          //找到所有的项目奖金的数据进行求和
          let program =this.findall(arr,'项目奖金')
          let program1 = []
          ...
          //找到所有的投资收入的数据进行求和
          let investment =this.findall(arr,'投资收入')
          let investment1 = []
