    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-container class="content">
          <el-main class="main">
              <div ref='chart' id="charts" style="width: 800px;height:400px;"></div>
              <h2>由上图可见金融投资方面占经济总量的比重越来越大，故推荐一些当前热门的基金供您选择</h2>
              <ul class="animate__animated animate__bounceInLeft animate__delay-2s" >
...
export default {
  ...
  data() {
    return {
      list:['广发小盘成长混合A','银华富裕主题混合','易方达消费行业股票','建信现金增利货币A','天鸿上证50指数C','华宝券商ETF联接C']
    }
  },
  methods: {
    drawchart(){
