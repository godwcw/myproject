          ...
          <el-main class="main">
            ...
            <el-dialog title="添加信息" :visible.sync="dialogFormVisible">
              <el-form :model="form">
                ...
                <el-form-item label="投入资金" :label-width="formLabelWidth">
            ...
            >
              ...
              <el-table-column label="投资资金" prop="incomenum"> </el-table-column>
              <el-table-column label="投资公司名" prop="kinds"> </el-table-column>
